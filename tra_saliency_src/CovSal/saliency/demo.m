...
salmap1 = saliencymap('I:\SaliencyModel\saliency360\Images\P34.jpg', options);

% Visual saliency estimation with covariances and means
options.modeltype = 'SigmaPoints';
% salmap2 = saliencymap('fish.png', options);
salmap2 = saliencymap('I:\SaliencyModel\saliency360\Images\P34.jpg', options);
% Display results
% im = imread('fish.png');
im = imread('I:\SaliencyModel\saliency360\Images\P34.jpg');
subplot(131);
