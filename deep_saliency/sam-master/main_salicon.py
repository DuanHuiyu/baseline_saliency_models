...
def generator(b_s, phase_gen='train', fixpts_type='mat'):
    if phase_gen == 'train':
    ...
    if len(sys.argv) == 1:
        ...
        if phase == 'train':
            ...
            if version == 0:
                ...
                m.fit_generator(generator(b_s=b_s, fixpts_type=fixpts_type), nb_imgs_train, nb_epoch=nb_epoch,
                                validation_data=generator(b_s=b_s, phase_gen='val', fixpts_type=fixpts_type), nb_val_samples=nb_imgs_val,
