...
train_image_paths = glob.glob(os.path.join(train_img_path, '*.png'))
train_image_paths += glob.glob(os.path.join(train_img_path, '*.jpg'))
train_imgs = []
for image_path in train_image_paths:
    train_imgs.append(os.path.basename(image_path))
val_image_paths = glob.glob(os.path.join(val_img_path, '*.png'))
val_image_paths += glob.glob(os.path.join(val_img_path, '*.jpg'))
val_imgs = []
for image_path in val_image_paths:
    val_imgs.append(os.path.basename(image_path))
