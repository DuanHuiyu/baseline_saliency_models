...
from src.data_utils_ar import getTest_loader
from src.salicon_model import Salicon



def test(model,device,test_loader,model_save_name='',output_dir='results'):
    model.eval()
...
def main():
    ...
    parser.add_argument('--test_data_csv', type=str, default='')
    ...
    dataloaders=getTest_loader(test_dataset_dir,args.test_img_dir,args.test_label_dir,data_csv=args.test_data_csv)
