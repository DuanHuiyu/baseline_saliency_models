...
from src.data_utils_changed import getTrainVal_loader
...
def main():
    ...
    dataloaders=getTrainVal_loader(args.train_dataset_dir,args.test_dataset_dir,args.train_img_dir,args.train_label_dir)
