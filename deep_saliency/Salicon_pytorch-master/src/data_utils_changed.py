...
class SaliconDataset(Dataset):
    ...
    def __init__(self,dataset_root,stimuli_dir,fixation_maps_dir,transform=None,use_cache=False,loadtype='train'):
    ...
    def __getitem__(self, index):
        ...
        if self.loadtype=='no_target':
            label=original_img.convert('L')
        else:
...
def getTrainVal_loader(train_dataset_dir,test_dataset_dir,img_dir,label_dir,shuffle=True,val_split=0.1):
...
def getTest_loader(test_dataset_dir,img_dir,label_dir,shuffle=True,loadtype='test'):
    ...
    test_dataset = SaliconDataset(test_dataset_dir, img_dir, label_dir, transform=data_transforms, loadtype=loadtype)
